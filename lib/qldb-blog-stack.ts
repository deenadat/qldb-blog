...
export class QldbBlogStack extends cdk.Stack {
    ...
    constructor(scope: cdk.Construct, id: string, props: QldbBlogStackProps) {
        ...
        crForProvQldbTables.node.addDependency(this.qldbLedger);
        ...
        this.qldbLedgerStream.node.addDependency(this.qldbLedger);
        ...
        const backupQldbLedger = new qldb.CfnLedger(this, 'BackupQldbBlogLedger', {
        ...
        replayPartiQLLambdaFn.node.addDependency(backupQldbLedger);

        // Assign QLDB permssion to lambda so it can execute the PartiQL statements against backup QLDB instance.
